<template>
    <section class="wrap w100 bg-default">
        ...
        <section class="w100 c-h pdt5" :style="{minHeight:minHeight+'px'}">
            <ul>
                <li class="article-item mg10 shadow" v-for="item in icons">
                    <a class="article-item-header clickable"
                       :href="item.masterHref" target="_blank">
                        <img :src="item.icon"/>
                        <a class="article-item-header-more" :href="'/m'+item.href">查看更多</a>
                    </a>
                    <ul>
                        <li class="article-item-content" v-for="(article,index) in articles(item)">
                            <div class="article-item-content-wrap clickable">
                                <h2>
